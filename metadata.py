...
fdata_template = './fma_metadata/{}'
modeldata_template = './in/fma_metadata/{}'
...
def _read_metaset(fpath):
    ...
    metaset_x = metaset.track_id.to_numpy()
    ...
    metaset_y = np.vstack((metaset.genre_top.to_numpy(), genres_all_lists))
